...
class ContratosControllerTest < ActionController::TestCase
  ...
  test "should create contrato" do
    assert_difference('Contrato.count') do
      post :create, contrato: { activo: @contrato.activo, carpeta: @contrato.carpeta, codigo: @contrato.codigo, descripcion: @contrato.descripcion, fecha: @contrato.fecha, nombre: @contrato.nombre }
    end
  ...
  test "should update contrato" do
    patch :update, id: @contrato, contrato: { activo: @contrato.activo, carpeta: @contrato.carpeta, codigo: @contrato.codigo, descripcion: @contrato.descripcion, fecha: @contrato.fecha, nombre: @contrato.nombre }
    assert_redirected_to contrato_path(assigns(:contrato))
  end
